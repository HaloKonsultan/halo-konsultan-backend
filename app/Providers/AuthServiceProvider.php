...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Gate::define('user-forum', function (User $user, 
        Forum $forum) {
        ...
        Gate::define('consultant-forum', function (Consultant $consultant, 
        Forum $forum) {
            return $consultant->id === $forum->consultant_id;
        });

        Gate::define('show-consultant', function(Consultant $consultant, $id){
            return $consultant->id === $id;
        });

        Gate::define('consultant-update', function(Consultant $consultant, $id){
            return $consultant->id === $id;
        });
    }
}
